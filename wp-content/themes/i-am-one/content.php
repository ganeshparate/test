    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        <header class="entry-header">
            ...
            <?php if ( 'post' == get_post_type() ) : ?>
                <div class="postmeta">
                    ...
                    <div class="post-categories"> | <?php echo skt_iamone_get_post_categories();?></div>
                    <div class="clear"></div>
                </div><!-- postmeta -->
            <?php endif; ?>
        ...
        <?php else : ?>
            <div class="entry-content">
                <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'skt-iamone' ) ); ?>
                <?php
                    wp_link_pages( array(
        ...
        <footer class="entry-meta" style="display:none;">
            ...
            <span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'skt-iamone' ), __( '1 Comment', 'skt-iamone' ), __( '% Comments', 'skt-iamone' ) ); ?></span>
            <?php endif; ?>
