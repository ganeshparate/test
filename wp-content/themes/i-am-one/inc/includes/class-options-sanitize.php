...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-iamone' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-iamone' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-iamone' ),
		'repeat'    => __( 'Repeat All', 'skt-iamone' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-iamone' ),
		'top center'    => __( 'Top Center', 'skt-iamone' ),
		'top right'     => __( 'Top Right', 'skt-iamone' ),
		'center left'   => __( 'Middle Left', 'skt-iamone' ),
		'center center' => __( 'Middle Center', 'skt-iamone' ),
		'center right'  => __( 'Middle Right', 'skt-iamone' ),
		'bottom left'   => __( 'Bottom Left', 'skt-iamone' ),
		'bottom center' => __( 'Bottom Center', 'skt-iamone' ),
		'bottom right'  => __( 'Bottom Right', 'skt-iamone')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-iamone' ),
		'fixed'  => __( 'Fixed in Place', 'skt-iamone')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-iamone' ),
		'italic'      => __( 'Italic', 'skt-iamone' ),
		'bold'        => __( 'Bold', 'skt-iamone' ),
		'bold italic' => __( 'Bold Italic', 'skt-iamone' )
		);
